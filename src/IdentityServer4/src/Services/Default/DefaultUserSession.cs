...
namespace IdentityServer4.Services
{
    ...
    public class DefaultUserSession : IUserSession
    {
        ...
        /// <summary>
        /// Stores whether an <see cref="AuthenticateAsync"/> call is in progress in order to prevent a stack overflow.
        /// </summary>
        private bool _authenticateInProgress;
        ...
        {
            if ((Principal == null || Properties == null) && !_authenticateInProgress)
            {
                try
                {
                    _authenticateInProgress = true;
